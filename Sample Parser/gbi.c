...
const CombineMode ccmodes_f3dex2[] = {
    {"G_CC_PRIMITIVE",              {0, 0, 0, 3,  0, 0, 0, 3}},
    {"G_CC_SHADE",                  {0, 0, 0, 4,  0, 0, 0, 4}},
    {"G_CC_MODULATEI",              {1, 0, 4, 0,  0, 0, 0, 4}},
    {"G_CC_MODULATEIA",             {1, 0, 4, 0,  1, 0, 4, 0}},
    {"G_CC_MODULATEIDECALA",        {1, 0, 4, 0,  0, 0, 0, 1}},
    {"G_CC_MODULATERGB",            {1, 0, 4, 0,  0, 0, 0, 4}},
    {"G_CC_MODULATERGBA",           {1, 0, 4, 0,  1, 0, 4, 0}},
    {"G_CC_MODULATERGBDECALA",      {1, 0, 4, 0,  0, 0, 0, 1}},
    {"G_CC_MODULATEI_PRIM",         {1, 0, 3, 0,  0, 0, 0, 3}},
    {"G_CC_MODULATEIA_PRIM",        {1, 0, 3, 0,  1, 0, 3, 0}},
    {"G_CC_MODULATEIDECALA_PRIM",   {1, 0, 3, 0,  0, 0, 0, 1}},
    {"G_CC_MODULATERGB_PRIM",       {1, 0, 3, 0,  0, 0, 0, 3}},
    {"G_CC_MODULATERGBA_PRIM",      {1, 0, 3, 0,  1, 0, 3, 0}},
    {"G_CC_MODULATERGBDECALA_PRIM", {1, 0, 3, 0,  0, 0, 0, 1}},
    {"G_CC_DECALRGB",               {0, 0, 0, 1,  0, 0, 0, 4}},
    {"G_CC_DECALRGBA",              {0, 0, 0, 1,  0, 0, 0, 1}},
    {"G_CC_BLENDI",                 {5, 4, 1, 4,  0, 0, 0, 4}},
    {"G_CC_BLENDIA",                {5, 4, 1, 4,  1, 0, 4, 0}},
    {"G_CC_BLENDIDECALA",           {5, 4, 1, 4,  0, 0, 0, 1}},
    {"G_CC_BLENDRGBA",              {1, 4, 8, 4,  0, 0, 0, 4}},
    {"G_CC_BLENDRGBDECALA",         {1, 4, 8, 4,  0, 0, 0, 1}},
    {"G_CC_ADDRGB",                 {1, 0, 1, 4,  0, 0, 0, 4}},
    {"G_CC_ADDRGBDECALA",           {1, 0, 1, 4,  0, 0, 0, 1}},
    {"G_CC_REFLECTRGB",             {5, 0, 1, 4,  0, 0, 0, 4}},
    {"G_CC_REFLECTRGBDECALA",       {5, 0, 1, 4,  0, 0, 0, 1}},
    {"G_CC_HILITERGB",              {3, 4, 1, 4,  0, 0, 0, 4}},
    {"G_CC_HILITERGBA",             {3, 4, 1, 4,  3, 4, 1, 4}},
    {"G_CC_HILITERGBDECALA",        {3, 4, 1, 4,  0, 0, 0, 1}},
    {"G_CC_SHADEDECALA",            {0, 0, 0, 4,  0, 0, 0, 1}},
    {"G_CC_BLENDPE",                {3, 5, 1, 5,  1, 0, 4, 0}},
    {"G_CC_BLENDPEDECALA",          {3, 5, 1, 5,  0, 0, 0, 1}},
    {"_G_CC_BLENDPE",               {5, 3, 1, 3,  1, 0, 4, 0}},
    {"_G_CC_BLENDPEDECALA",         {5, 3, 1, 3,  0, 0, 0, 1}},
    {"_G_CC_TWOCOLORTEX",           {3, 4, 1, 4,  0, 0, 0, 4}},
    {"_G_CC_SPARSEST",              {3, 1, 13, 1, 3, 1, 0, 1}},
    {"G_CC_TEMPLERP",               {2, 1, 14, 1, 2, 1, 6, 1}},
    {"G_CC_TRILERP",                {2, 1, 13, 1, 2, 1, 0, 1}},
    {"G_CC_INTERFERENCE",           {1, 0, 2, 0,  1, 0, 2, 0}},
    {"G_CC_1CYUV2RGB",              {1, 7, 15, 1, 0, 0, 0, 4}},
    {"G_CC_YUV2RGB",                {2, 7, 15, 2, 0, 0, 0, 0}},
    {"G_CC_PASS2",                  {0, 0, 0, 0,  0, 0, 0, 0}},
    {"G_CC_MODULATEI2",             {0, 0, 4, 0,  0, 0, 0, 4}},
    {"G_CC_MODULATEIA2",            {0, 0, 4, 0,  0, 0, 4, 0}},
    {"G_CC_MODULATERGB2",           {0, 0, 4, 0,  0, 0, 0, 4}},
    {"G_CC_MODULATERGBA2",          {0, 0, 4, 0,  0, 0, 4, 0}},
    {"G_CC_MODULATEI_PRIM2",        {0, 0, 3, 0,  0, 0, 0, 3}},
    {"G_CC_MODULATEIA_PRIM2",       {0, 0, 3, 0,  0, 0, 3, 0}},
    {"G_CC_MODULATERGB_PRIM2",      {0, 0, 3, 0,  0, 0, 0, 3}},
    {"G_CC_MODULATERGBA_PRIM2",     {0, 0, 3, 0,  0, 0, 3, 0}},
    {"G_CC_DECALRGB2",              {0, 0, 0, 0,  0, 0, 0, 4}},
    {"G_CC_BLENDI2",                {5, 4, 0, 4,  0, 0, 0, 4}},
    {"G_CC_BLENDIA2",               {5, 4, 0, 4,  0, 0, 4, 0}},
    {"G_CC_CHROMA_KEY2",            {1, 6, 6, 0,  0, 0, 0, 0}},
    {"G_CC_HILITERGB2",             {5, 0, 1, 0,  0, 0, 0, 4}},
    {"G_CC_HILITERGBA2",            {5, 0, 1, 0,  5, 0, 1, 0}},
    {"G_CC_HILITERGBDECALA2",       {5, 0, 1, 0,  0, 0, 0, 1}},
    {"G_CC_HILITERGBPASSA2",        {5, 0, 1, 0,  0, 0, 0, 0}},
    {"G_CC_PRIMLITE",               {4, 0, 3, 0,  0, 0, 0, 3}},
};
