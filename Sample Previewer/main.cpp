...
Main::Main() : wxFrame(nullptr, wxID_ANY, PROGRAM_NAME, wxPoint(0, 0), wxSize(640, 480))
{
    ...
    attribs.PlatformDefaults().MinRGBA(8, 8, 8, 8).DoubleBuffer().Depth(32).EndList();
    this->m_Model_Canvas = new ModelCanvas(this->m_Splitter_Vertical, attribs, wxID_ANY, wxDefaultPosition, wxDefaultSize, wxSUNKEN_BORDER, "");
