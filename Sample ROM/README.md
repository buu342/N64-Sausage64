...
This folder contains a sample ROM for the Nintendo64, which demonstrates the exported model and animations (from the [../Sample Model](Sample Model Folder) in action. 
